// code example taken from here https://www.youtube.com/watch?v=qqq4E6PU2vQ
...
ctx.fillText('Travel Master', 0, 12);
...
class Particle {
    constructor(x, y) {
        ...
        this.baseX = this.x;
        this.baseY = this.y;
        this.density = (Math.random() * 5) + 0.5; //how fas particles moves
        this.distance;
    }
