...
playerLeft.src = 'assets/img/fish-swim-left.png';
const playerRight = new Image();
playerRight.src = 'assets/img/fish-swim-right.png';
...
bubble.src = 'assets/img/pop2.png';
class Bubble {
    constructor(){
...
ctx.fillText('TRAVEL', 20, 28);
ctx.fillText('MASTER', 20, 48);
...
function animate(){
    ...
    ctx.fillText('score: ' + score, 141, 436);
    ctx.fillStyle = 'rgba(34,147,214,1)';
    ctx.fillText('score: ' + score, 140, 435);
    gameFrame += 1;
